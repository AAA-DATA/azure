...
USER_CLIENT_ID="0b5edf4e-930f-4882-b252-3103aeeb3a76"
USER_KEY="3qUBaT/gCpfBIfQkn2180PBvPwTcdXGnLsyKwZqPaL0="
USER_DIRECTORY_ID="d3f969e5-42a3-4d6c-a617-7b969dd92ea1"
KEY_VAULT_NAME="aaadatasecrets"
...
do
	...
	########################################################################################################################							
                               ...
                               userpassword=$(curl -H "Authorization: Bearer $token" -vv https://$KEY_VAULT_NAME.vault.azure.net/secrets/aaa-hdi-user-$username?api-version=7.0 | cut -d ',' -f 1 | cut -d ':' -f 2 | cut -d '"' -f 2)
